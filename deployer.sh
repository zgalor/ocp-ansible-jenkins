...
#
MASTER_HOSTNAME="${NAME_PREFIX}-master01.${MASTER_IP}.xip.io"
...
do
  INFRA_HOST="${NAME_PREFIX}-infra$(printf %02d $COUNTER).${INFRA_IP}.xip.io"
...
do
  COMPUTE_HOST="${NAME_PREFIX}-compute$(printf %02d $COUNTER).${COMPUTE_IP}.xip.io"
